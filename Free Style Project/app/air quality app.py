...
airStatusDict = {"1":"Go out free","2":"Go out for short time.","3":"Please Wear a mask","4":"Plesase Wear a Special mask","5":"Stay Home ","6":"Stay Home","7":"Unavialbale"}
...
def enterZipCode():
    ...
    while len(zip_code) != 5:
        print("Enter the correct code code")
        zip_code = input("please enter a zip code: ")
    return zip_code
